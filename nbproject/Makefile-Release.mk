...
${OBJECTDIR}/src/base.o: src/base.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/base.o src/base.cpp

${OBJECTDIR}/src/battlescene.o: src/battlescene.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/battlescene.o src/battlescene.cpp
...
${OBJECTDIR}/src/room.o: src/room.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/room.o src/room.cpp
