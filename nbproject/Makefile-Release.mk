...
${OBJECTDIR}/_ext/708781350/base.o: /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/base.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/708781350/base.o /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/base.cpp
...
${OBJECTDIR}/_ext/708781350/resourcemanager.o: /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/resourcemanager.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/708781350
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/708781350/resourcemanager.o /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/resourcemanager.cpp

${OBJECTDIR}/_ext/708781350/room.o: /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/room.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/708781350
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/708781350/room.o /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/room.cpp
...
${OBJECTDIR}/src/cardfactory.o: src/cardfactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cardfactory.o src/cardfactory.cpp
...
${OBJECTDIR}/src/fort.o: src/fort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fort.o src/fort.cpp
