...
${OBJECTDIR}/_ext/708781350/buttonobject.o: /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/buttonobject.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/708781350/buttonobject.o /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/buttonobject.cpp

${OBJECTDIR}/_ext/708781350/events.o: /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/events.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/708781350
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/708781350/events.o /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/events.cpp

${OBJECTDIR}/_ext/708781350/mainmenu.o: /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/mainmenu.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/708781350
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/708781350/mainmenu.o /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/mainmenu.cpp

${OBJECTDIR}/_ext/708781350/object.o: /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/object.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/708781350
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/708781350/object.o /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/object.cpp

${OBJECTDIR}/_ext/708781350/scene.o: /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/scene.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/708781350
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/local/lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/708781350/scene.o /mnt/LinuxHome/sbachstein/Workspace/netbeans/HouseOfCards/src/scene.cpp
